#!/usr/bin/env python3
"""
AI Sizing Normalizer — overlap-ring outpainting for ComfyUI.
...
def main():
    ...
    ap.add_argument(
        "--output-dir",
        help="destination folder (default: INPUT/ai-sized)",
    )
    ap.add_argument(
        "--comfy-url",
        default=COMFY_URL,
    ...
    output_dir = os.path.abspath(
        os.path.expanduser(args.output_dir or os.path.join(input_dir, "ai-sized"))
    )
